...
#ifdef STANDALONE
  #define PRODUCT_NAME				"serkaengine"
  #define BASEGAME					"serka"
  #define CLIENT_WINDOW_TITLE		"misfortunegame"
  #define CLIENT_WINDOW_MIN_TITLE	"misfortune"
  #define HOMEPATH_NAME_UNIX		".srk"
  #define HOMEPATH_NAME_WIN			"Misfortune"
  #define HOMEPATH_NAME_MACOSX		HOMEPATH_NAME_WIN
//  #define STEAMPATH_NAME			"Foo Bar"
//  #define STEAMPATH_APPID         ""
  #define GAMENAME_FOR_MASTER		"serka"	// must NOT contain whitespace
  #define CINEMATICS_LOGO		"srklogo.roq"
